...
import { CouponCode } from "@/(pages)/(checkout)/checkout/components/resume-checkout/sub-components/coupon-code/index";
import { Freightage } from "@/(pages)/(checkout)/checkout/components/resume-checkout/sub-components/freightage/index";
...
function ResumePayment() {
  ...
  const { address, method, cardId, dataProducts, discount, total, setTotal } =
    contextPay;
